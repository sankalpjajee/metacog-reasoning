"""
ACC-Inspired Probe Training (V4.5)

V4.5 removes tanh activation + uses 20x weight for positive utility samples.

Key changes from V4.3:
- **NO tanh on utility head** (unbounded output) ← KEY FIX!
- Weighted MSE loss for utility (20x weight on positive samples)
- Probe can now output full range including +0.7
...
5. **NO tanh + WEIGHTED loss (20x)** ← SHOULD ENABLE ROUTING!
