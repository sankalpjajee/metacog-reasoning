"""
ACC-Inspired Probe Training (V4.1)

V4.1 removes compressed hidden states based on ablation study findings.
Uses only dynamic features (9 dims) + early entropy (2 dims) = 11 dims total.
Ablation showed 4.2x better utility correlation (28.3% vs 6.8%) without compressed hidden!
